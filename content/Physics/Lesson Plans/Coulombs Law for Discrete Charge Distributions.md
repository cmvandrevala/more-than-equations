...
- Electric Force Distributions of Point Charges
- Review of Newton's Laws as They Relate to Electric Force

## 🎯 Objectives

- Calculate the forces on distributions of point charges using Coulomb's law
- Utilize superposition to calculate the net force from multiple point charges

## 📋 Sequence

- 🟣 Force between multiple point charges positioned at arbitrary points in the xy-plane
- 🟣 Force between point charges fixed on the corners of a square
- 🟣 Force between point charges fixed on the corners of an equilateral triangle
